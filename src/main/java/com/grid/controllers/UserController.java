...
//        List<LineInspector> lst = service.UserDownload(us);
        List<Inspectors> lst = userDao.listUsers(us);
//        result.put("users", lst);
     ...
     * @throws Exception
     */
    private void userExcel(List<Inspectors> users, WritableWorkbook workbook, boolean flag) throws Exception {
...
//
    ...
    @ResponseBody
    @CrossOrigin(origins = "*", maxAge = 3600)
    public Object deleteUsers(String users, String line) {
        Map<String, Object> result = new HashMap<String, Object>();
//        List<String> us = new ArrayList<String>();
        String[] us = users.split("_");
...
//
    ...
    public Object cityUsers(String city,HttpServletResponse res) {
        Map<String, Object> result = new HashMap<String, Object>();
//        List<String> us = new ArrayList<String>();
        List<Inspectors> inspectors = userDao.listCityUsers(city);
        res.setHeader("content-type", "application/octet-stream");
        res.setContentType("application/octet-stream");
        res.setHeader("Content-Disposition", "attachment;filename=" + "巡线员.xls");
        result.put("result", "0");
...
//
    ...
    public Object allUsers(HttpServletResponse res) {
        Map<String, Object> result = new HashMap<String, Object>();
//        List<String> us = new ArrayList<String>();
        List<Inspectors> inspectors = userDao.listAllUsers();
        res.setHeader("content-type", "application/octet-stream");
        res.setContentType("application/octet-stream");
